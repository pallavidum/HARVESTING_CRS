...
export class HelperService {
  ...
  fakeLogin(): Observable<LoginResponse> {
    const loginRes: LoginResponse = {
      'token': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..PFV5xVYf1j63M9bKJ0ylxh1z0U7Rylb1uyLG6H0TUcc',
      'expiresIn': 1200,
      'roleIds': [
        '2',
      ],
